...
// for (let index in names) { // for in - лучше не использовать с массивами
// }
...
//   port = 4200
// }
const port = `process.env.PORT in Node.js` || 4200
...
//   return `rgb(${r}, ${g}, ${b})`
// }
const rgb = (r, g = 255, b = 155) => `rgb(${r}, ${g}, ${b})`
...
console.log(~~9.7 === 9) // ~~ - это сокращенная запись Math.floor()
...
const float = +'42.42'
// или
const int2 = Number('42')
const float2 = Number('42.42')
